...
$query="insert into  table_book(user_id,user_mail,table_no,date,time) values('$user_id','$user_mail','$table_no','$date','$time')";
$query_check=mysqli_query($conn,$query);
echo"<script>alert('Table Succssfully booked');</script>";
}
?>
...
<a download="messmenu.png" href="/path/to/image" title="Mess Menu">
    <img alt="MessMenu" src="messmenu.png">
</a>
<!-- Hostel Name -->
...
<div class="col-sm-8">
<select name="table_no" id="hostel"class="form-control"  onChange="getSeater(this.value);" onBlur="checkAvailability()" required> 
