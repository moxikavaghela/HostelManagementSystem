...
$query="insert into  gatepass(regno,date,time,fname,mname,lname,contactno,reason,udate) values('$regno','$date','$time','$fname','$mname','$lname','$contact','$reason','$udate')";
//echo $query;die;
$query_check=mysqli_query($conn,$query);
echo"<script>alert('gatepass added successfully');</script>";
}
?>
...
<input type="submit" name="update" Value="Submit Gatepass" class="btn btn-primary">
</div>
</form>
