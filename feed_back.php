...
$db1=mysqli_select_db($conn,"hostel");
$query="insert into  feedback(mess,day,regno,fname,mname,lname,contactno,feedback,udate) values('$mess','$day','$regno','$fname','$mname','$lname','$contact','$feedback','$udate')";
$query_check=mysqli_query($conn,$query);
echo"<script>alert('Feed back added successfully');</script>";
}
?>
...
<label class="col-sm-2 control-label">Mess : </label>
<div class="col-sm-8">
...
<div class="col-sm-8">
<input type="text" name="feedback" id="feedback"  class="form-control"    required="required" >
</div>
</div>
<?php } ?>
...
<input type="submit" name="update" Value="Submit Feedback" class="btn btn-primary">
</div>
</form>
